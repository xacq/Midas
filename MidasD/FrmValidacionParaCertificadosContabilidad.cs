...
namespace MidasD
{
    public partial class FrmValidacionParaCertificadosContabilidad : Form
    {
        ...
        public FrmValidacionParaCertificadosContabilidad(SrMidasD.Usuario usuario)
        {
            InitializeComponent();
        ...
        public async Task listarFianzas()
        {
            ...
            paValidacionParaCertificadosContabilidad_Result[] asyncVariable1 = await this.servicio.paValidacionParaCertificadosContabilidadAsync(Util.header, txtBuscar.Text, Convert.ToInt32(cbxAnio.SelectedItem.ToString()), Convert.ToInt32(cbxUnidadEjecutora.SelectedValue.ToString()));
            asyncVariable0.DataSource = asyncVariable1;
            asyncVariable0 = null;
            asyncVariable1 = null;

            Utils.Wfa.hideHeadersDGV(dgvListaFianzas, new List<string>() { "idFianza" });
            Utils.Wfa.positionHeadersDGV(dgvListaFianzas, new List<string>() {"Nro_Fianza", "cargo", "apellidos_Y_Nombres","ci", "item", "h_b","estado_Cuenta_Gestion_Pasada","enero","febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre","totalDescuento","totalDescontar"});
        ...
        public async Task listarFianzasValidadasContabilidad()
        {
            frmCargando = new FrmCargando();
            frmCargando.Show();
            await Task.Delay(250);
            ...
            DataGridView asyncVariable0 = this.dgvValidadasContabilidad;
            paValidacionEstadoFianzaContabilidad_Result[] asyncVariable1 = await this.servicio.paValidacionEstadoFianzaContabilidadAsync(Util.header, txtBuscar.Text, Convert.ToInt32(cbxAnio.SelectedItem.ToString()), Convert.ToInt32(cbxUnidadEjecutora.SelectedValue.ToString()));
            asyncVariable0.DataSource = asyncVariable1;
            asyncVariable0 = null;
            asyncVariable1 = null;

            Utils.Wfa.hideHeadersDGV(dgvValidadasContabilidad, new List<string>() { "idFianza", "Validado_Por_Habilitacion", "fecha_Habilitacion", "Usuario_Habilitacion" });
            Utils.Wfa.positionHeadersDGV(dgvValidadasContabilidad, new List<string>() { "Nro_Fianza", "cargo", "apellidos_Y_Nombres", "ci", "item", "h_b", "estado_Cuenta_Gestion_Pasada", "enero", "febrero", "marzo", "abril", "mayo", "junio", "julio", "agosto", "septiembre", "octubre", "noviembre", "diciembre", "totalDescuento", "totalDescontar", "Validado_Por_Contabilidad", "fecha_Contabilidad", "Usuario_Contabilidad" });
            Utils.Wfa.setHeadersDGV(dgvValidadasContabilidad);
            dgvValidadasContabilidad.AutoResizeColumns();
            dgvValidadasContabilidad.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
        ...
        public async Task listarEstadoValidaciones()
        {
            ...
            dgvEstadoValidaciones.DataSource = servicio.paValidacionEstadoFianzaRRHH(Util.header, txtBuscar.Text, Convert.ToInt32(cbxAnio.SelectedItem.ToString()), Convert.ToInt32(cbxUnidadEjecutora.SelectedValue.ToString()));

            Utils.Wfa.hideHeadersDGV(dgvEstadoValidaciones, new List<string>() { "idFianza" });
            Utils.Wfa.positionHeadersDGV(dgvEstadoValidaciones, new List<string>() { "Nro_Fianza", "cargo", "apellidos_Y_Nombres", "ci", "item", "h_b","totalDescuento", "totalDescontar", "Validado_Por_Habilitacion", "fecha_Habilitacion", "Usuario_Habilitacion", "Validado_Por_Contabilidad", "fecha_Contabilidad", "Usuario_Contabilidad" });
        ...
        private async void btnCancelar_Click(object sender, EventArgs e)
        {
            ...
            string namepage = tbpValidacionConta.SelectedTab.Name;
            ...
            {
                await listarFianzasValidadasContabilidad();
            }
        ...
        private async void frmEntrada_Load(object sender, EventArgs e)
        {
            ...
            dgvValidadasContabilidad.RowPostPaint += Utils.Wfa.rowPostPaintDGV;
        ...
        private void dgvValidadasContabilidad_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            try
            {
                foreach (DataGridViewRow item in dgvValidadasContabilidad.Rows)
                {
                    int index = item.Index;
                    Util.pintarDatagridwiewIndex(dgvValidadasContabilidad, index, "Black", "Gold");
                    dgvValidadasContabilidad.ClearSelection();
                }
            }
            catch { }
        }
