...
namespace MidasD
{
    public partial class FrmFianzaDeBaja : Form
    {
        ...
        public FrmFianzaDeBaja(SrMidasD.Usuario usuario)
        {
            InitializeComponent();
        ...
        private async Task listar()
        {
            ...
            paFuncionarioFianzaActualBuscar_Result[] asyncVariable1 = await this.servicio.pafuncionarioFianzaActualBuscarAsync(Util.header, txtBuscar.Text.Trim().ToLower(), Convert.ToInt32(cbxUnidadEjecutora.SelectedValue.ToString()), 2);
            asyncVariable0.DataSource = asyncVariable1;
            asyncVariable0 = null;
            asyncVariable1 = null;

            Utils.Wfa.hideHeadersDGV(dgvLista, new List<string>() { "idFianza", "item", "vigencia_Contrato", "fecha_Memorando", "a_Descontar","resolucion_Administrativa" });
        ...
        private bool validarCampos()
        {
            ...
            {
                Util.errorMensaje(erpError,lblNombre,"Debe Introducir el Motivo de la Baja ");
            }
        ...
        private async Task editar()
        {
            ...
            DialogResult ResultadoDialogo = MessageBox.Show("La Fianza del Funcionario será dado de baja.\r¿Desea continuar?.", "::: MidasD - Consulta :::", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (ResultadoDialogo == DialogResult.Yes)
            {
                try
                {
                    ...
                    limpiarcampos();
                    MessageBox.Show("Se ha dado de Baja Correctamente Correctamente.", "::: MidasD - Información :::", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
