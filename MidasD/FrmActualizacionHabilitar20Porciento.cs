...
namespace MidasD
{
    public partial class FrmActualizacionHabilitar20Porciento : Form
    {
        ...
        public FrmActualizacionHabilitar20Porciento(SrMidasD.Usuario usuario)
        {
            InitializeComponent();
        ...
        private async Task editar()
        {
            ...
            try
            {
                ...
                Descuento fianzaFuncionarioMes = servicio.descuentoVerificarMesRegistrado(Util.header,idFianza, Convert.ToInt32(cbxMes.SelectedValue.ToString()), Convert.ToInt32(txtAnio.Text.ToString()));
                ...
                else
                {
                    ...
                    descuentoActualizar.anio = Convert.ToInt32(txtAnio.Text.ToString());
