...
namespace MidasD
{
    public partial class FrmRegistroFianzaBienesAdministrador : Form
    {
        ...
        public FrmRegistroFianzaBienesAdministrador(SrMidasD.Usuario usuario)
        {
            InitializeComponent();
            ...
            Util.btn_Mouse(new List<PictureBox>() { btnEditar, btnBaja,btnBuscar, 
            btnCancelar, btnGuardar, btnSalir,btnNuevo,btnImprimir,btnQuitarSeleccion });
        ...
        private  void cargarCampos()
        {
            ...
            {
                MessageBox.Show("Edite con precaucion porque el funcionario ya tiene esta fianza con Resolucion y esta validada por Contabilidad.", "::: MidasD - Información :::", MessageBoxButtons.OK, MessageBoxIcon.Information);
