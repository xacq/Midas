...
namespace MidasD
{
    public partial class FrmRegistroFianzaBienes : Form
    {
        ...
        public FrmRegistroFianzaBienes(SrMidasD.Usuario usuario)
        {
            InitializeComponent();
        ...
        private async  void cargarCampos()
        {
            ...
            if (!validado)
            {
                ...
                cbxCargo.ValueMember = "idCargo";/*Ayuda de carga de los cargos*/
